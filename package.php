                ...
                <div class="pricing-card h-100 d-flex flex-column landing">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <ul class="pricing-list">
                            ...
                            <li>Contact form + CTA section</li>
                            <li><b>Basic</b>&nbsp;SEO setup</li>
                            <li>Social media + WhatsApp integration</li>
                            <li><b>1x</b>&nbsp;minor revision</li>
                        </ul>
                        <div class="package-note">
                            Perfect for students & personal projects. Does not include free hosting or domain.
                        </div>
                    </div>
                ...
                <div class="pricing-card h-100 d-flex flex-column business">
                    <div class="flex-grow-1">
                        ...
                        <ul class="pricing-list">
                            ...
                            <li>Up to 10 pages or basic E-commerce</li>
                            <li>Responsive layout</li>
                            <li><b>Custom UI/UX</b>&nbsp;design request</li>
