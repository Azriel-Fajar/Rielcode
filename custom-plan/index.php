...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($customPreset, ['blank','copy'], true)) $customPreset = 'blank';
...
// ─── Preset detection (from URL ?preset=blank|copy) ──────────────────────────
$activePreset = $_GET['preset'] ?? 'blank';
if (!in_array($activePreset, ['blank','copy'], true)) $activePreset = 'blank';
...
<body class="rc-redesign">
    ...
    <div class="cp-page">
        ...
        <div class="cp-wrapper">
            ...
            <style>
                .cp-presets { display:grid; grid-template-columns: repeat(2, 1fr); gap: 14px; margin: 8px 0 28px; }
    ...
    (function () {
        ...
        window.cpCalc = function () {
            ...
            if (totalDisplay) totalDisplay.textContent = fmt(effective);
