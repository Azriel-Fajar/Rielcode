<nav class="rc-nav rc-nav--blur" id="rc-nav">
    <div class="rc-nav__inner rc-container">
        <a class="rc-nav__logo" href="#hero">
            <img src="IMG/Rielcode Logo Transparent.png" alt="Rielcode">
        </a>
        <ul class="rc-nav__links">
            <li><a href="#hero"         class="rc-nav__link" data-target="hero">Home</a></li>
            <li><a href="#packages"     class="rc-nav__link" data-target="packages">Packages</a></li>
            <li><a href="#about"        class="rc-nav__link" data-target="about">About</a></li>
            <li><a href="#projects"     class="rc-nav__link" data-target="projects">Projects</a></li>
            <li><a href="#requirements" class="rc-nav__link" data-target="requirements">Requirements</a></li>
            <li><a href="#contact"      class="rc-nav__link" data-target="contact">Contact</a></li>
        </ul>
        <div class="rc-nav__cta">
            <a class="rc-btn rc-btn-sm" href="order-form/">
                Start a Project
    ...
    <div class="rc-mnav" id="rc-mnav" role="dialog" aria-modal="true" aria-hidden="true">
        ...
        <ul class="rc-mnav__list">
            <li><span class="rc-mnav__num">01</span><a href="#hero">Home</a></li>
            <li><span class="rc-mnav__num">02</span><a href="#packages">Packages</a></li>
            <li><span class="rc-mnav__num">03</span><a href="#about">About</a></li>
            <li><span class="rc-mnav__num">04</span><a href="#projects">Projects</a></li>
            <li><span class="rc-mnav__num">05</span><a href="#requirements">Requirements</a></li>
            <li><span class="rc-mnav__num">06</span><a href="#contact">Contact</a></li>
        </ul>
